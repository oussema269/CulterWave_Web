 ...
 */
final class Version20230326003304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX id-owner ON produit');
        $this->addSql('ALTER TABLE produit CHANGE lib lib VARCHAR(255) DEFAULT NULL, CHANGE stock stock INT DEFAULT NULL, CHANGE id-owner id_owner INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE lib lib VARCHAR(255) NOT NULL, CHANGE stock stock INT NOT NULL, CHANGE id_owner id-owner INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX fk_categorie ON produit (id_cat)');
        $this->addSql('CREATE INDEX id-owner ON produit (id-owner)');
    }
}
