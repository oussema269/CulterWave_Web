...
\t\t\t\t<td>";
        // line 37
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 37, $this->source); })()), "isActive", [], "any", false, false, false, 37), "html", null, true);
        echo "</td>
\t\t\t</tr>
\t\t</tbody>
\t</table>
...
";
    ...
    {
        return array (  153 => 45,  148 => 43,  139 => 37,  132 => 33,  125 => 29,  118 => 25,  111 => 21,  104 => 17,  97 => 13,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
