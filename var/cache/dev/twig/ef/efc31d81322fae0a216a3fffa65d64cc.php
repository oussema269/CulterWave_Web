...
";
        ...
        echo "
<button class=\"btn bn632-hover bn20\">";
        // line 3
...
{{ form_widget(form) }}
<button class=\"btn bn632-hover bn20\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\xampp\\htdocs\\pisymfony\\testfortest-master\\templates\\user\\_form.html.twig");
    }
}
