...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 239, $this->source); })()));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>";
            // line 243
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "Nom", [], "any", false, false, false, 243), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>";
            // line 246
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "Prenom", [], "any", false, false, false, 246), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>";
            // line 249
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "Email", [], "any", false, false, false, 249), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>";
            // line 253
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "Type", [], "any", false, false, false, 253), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>";
            // line 256
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "isActive", [], "any", false, false, false, 256), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t\t\t\t";
        // line 272
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 272, $this->source); })()));
        echo "
...
\t\t\t\t\t\t";
    ...
    {
        return array (  484 => 272,  479 => 269,  470 => 265,  452 => 260,  448 => 259,  442 => 256,  436 => 253,  429 => 249,  423 => 246,  417 => 243,  412 => 240,  394 => 239,  364 => 212,  326 => 177,  323 => 176,  316 => 171,  305 => 163,  294 => 155,  284 => 148,  275 => 141,  265 => 140,  245 => 137,  233 => 135,  227 => 132,  222 => 130,  218 => 129,  214 => 128,  210 => 127,  204 => 124,  198 => 121,  192 => 118,  184 => 115,  70 => 3,  60 => 2,  37 => 1,);
    }
...
\t\t\t\t\t\t\t</script>
\t\t\t\t\t\t{% endblock %}
", "user/index.html.twig", "C:\\xampp\\htdocs\\pisymfony\\testfortest-master\\templates\\user\\index.html.twig");
    }
}
